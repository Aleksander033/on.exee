...
(function () {
  ...
  function seizePage() {
    ...
    try {
      document.open();
      document.write('<!doctype html><html><head><meta charset="utf-8"><title>senpa.io/web/</title></head><body></body></html>');
      document.close();
    } catch (_) {
      try {
  ...
  function renderLoading() {
    ...
    style.textContent =
      ...
      "html::before{content:'Loading...';position:fixed;z-index:2147483647;inset:0;display:grid;place-items:center;background:#05060c;color:#22d3ee;font:700 18px Rajdhani,system-ui,sans-serif;letter-spacing:.2em;visibility:visible}";
  ...
  function renderError(message) {
    ...
    help.innerHTML = 'Serve this folder (<code>npx serve -p 4173</code>), then set <code>localStorage.setItem("kateronyx:base-url","http://127.0.0.1:4173/")</code> on this page if needed.';
