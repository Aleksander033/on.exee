...
(function () {
  ...
  function renderLoading() {
    ...
    style.textContent = `
      ...
      html::before{content:'Loading...';position:fixed;z-index:2147483647;inset:0;display:grid;place-items:center;background:#07090d;color:#dce7f4;font:16px system-ui,sans-serif;visibility:visible}
    `;
